      ...
      <div class="w-screen h-screen overflow-hidden bg-primary-900 text-primary-100">
        <div class="p-2 w-full md:w-1/2 xl:w-1/3 mx-auto flex flex-col gap-4">
          <div class="flex justify-between items-center">
            <h1 class="text-4xl font-bold text-center text-accent-400">Actle</h1>
            <div class="flex gap-2 justify-center items-center">
              ...
              <Modal Icon={AboutIcon} title="About" >
                ...
                <p>
                  Each day a new movie is chosen from a curated list, and the actors are based on the top 6 actors provided by the <a target="_blank" href="https://developer.themoviedb.org/reference/intro/getting-started">TMDB API</a>.
                </p>
                <p>
